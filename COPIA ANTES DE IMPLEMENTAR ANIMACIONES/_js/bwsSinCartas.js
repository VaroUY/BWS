...
var _jugadores = [["Sin Asignar"],["Sin Asignar"],["Sin Asignar"],["Sin Asignar"]]
...
//	localStorage.setItem('jugarCartasMaso',_jugarCartasMaso);
...
//	_jugarCartasMaso = Number(localStorage.getItem('jugarCartasMaso'));
	_jugarCartasMaso = true;
	...
	document.getElementById("Jugador"+String(_turnoJugador+1)+"_Linea").style= "border-color: black; border-width: 0.5px;" ;
	document.getElementById("Jugador"+String(_turnoJugador+1)+"_V_Linea").style= "border-color: black; border-width: 0.5px;" ;
...
function jugarCartasCompletar() {
	...
	if (cartasMaestro[_valorIndice][0]=="1000") {
		terminarJugadaCartas("parametro no necesario, no chequea marca cuando es 1000");
		finalizarJugada();
//		alert("carta 1000");
		return;
	}
	...
	switch (cartasMaestro[_valorIndice][1]) {

		case "N" :

			switch (cartasMaestro[_valorIndice][0]) {
...
//    	myWindow.opener.just_a_variable = v; 
    	myWindow.close();
  		switch (_popUpRadio) {
				...
				case 1 :
 					myWindow.opener.terminarJugadaCartas("H");
  					break;
				case 2 :
 					myWindow.opener.terminarJugadaCartas("G");
  					break;	
				case 3 :
 					myWindow.opener.terminarJugadaCartas("N");
  					break;
				case 4 :
 					myWindow.opener.terminarJugadaCartas("M");
  					break;
...
/*	if (document.getElementById("altasJ1").value != "..." ) {

		document.getElementById("Jugador1_Nombre").innerHTML = document.getElementById("altasJ1").value;
		document.getElementById("Jugador1_V_Nombre").innerHTML = document.getElementById("altasJ1").value;
		document.getElementById("Jugador1_Total").innerHTML = num2Format(4000);
		document.getElementById("Jugador1_Cash").innerHTML = "0";
		document.getElementById("Jugador1_Heineken").innerHTML = "1";
		document.getElementById("Jugador1_Gatorade").innerHTML = "1";
		document.getElementById("Jugador1_Nike").innerHTML = "1";
		document.getElementById("Jugador1_McDonalds").innerHTML = "1";

		_jugadores[0][0] = document.getElementById("altasJ1").value;

	} 

	if (document.getElementById("altasJ2").value != "..." ) {

		document.getElementById("Jugador2_Nombre").innerHTML = document.getElementById("altasJ2").value;
		document.getElementById("Jugador2_V_Nombre").innerHTML = document.getElementById("altasJ2").value;
		document.getElementById("Jugador2_Total").innerHTML = num2Format(4000);
		document.getElementById("Jugador2_Cash").innerHTML = "0";
		document.getElementById("Jugador2_Heineken").innerHTML = "1";
		document.getElementById("Jugador2_Gatorade").innerHTML = "1";
		document.getElementById("Jugador2_Nike").innerHTML = "1";
		document.getElementById("Jugador2_McDonalds").innerHTML = "1";
		_jugadores[1][0] = document.getElementById("altasJ2").value;

	} 

	if (document.getElementById("altasJ3").value != "..." ) {

		document.getElementById("Jugador3_Nombre").innerHTML = document.getElementById("altasJ3").value;
		document.getElementById("Jugador3_V_Nombre").innerHTML = document.getElementById("altasJ3").value;
		document.getElementById("Jugador3_Total").innerHTML = num2Format(4000);
		document.getElementById("Jugador3_Cash").innerHTML = "0";
		document.getElementById("Jugador3_Heineken").innerHTML = "1";
		document.getElementById("Jugador3_Gatorade").innerHTML = "1";
		document.getElementById("Jugador3_Nike").innerHTML = "1";
		document.getElementById("Jugador3_McDonalds").innerHTML = "1";
		_jugadores[2][0] = document.getElementById("altasJ3").value;

	} 

	if (document.getElementById("altasJ4").value != "..." ) {

		document.getElementById("Jugador4_Nombre").innerHTML = document.getElementById("altasJ4").value;
		document.getElementById("Jugador4_V_Nombre").innerHTML = document.getElementById("altasJ4").value;
		document.getElementById("Jugador4_Total").innerHTML = num2Format(4000);
		document.getElementById("Jugador4_Cash").innerHTML = "0";
		document.getElementById("Jugador4_Heineken").innerHTML = "1";
		document.getElementById("Jugador4_Gatorade").innerHTML = "1";
		document.getElementById("Jugador4_Nike").innerHTML = "1";
		document.getElementById("Jugador4_McDonalds").innerHTML = "1";
		_jugadores[3][0] = document.getElementById("altasJ4").value;
	} */


	document.getElementById('TurnoJugador').innerHTML = _jugadores[_turnoJugador][0];
	document.getElementById("Jugador1_Linea").style= "border-color: black; border-width: 0.5px;" ;
	document.getElementById("Jugador1_V_Linea").style= "border-color: black; border-width: 0.5px;" ;
...
function terminarJugadaCartas(_empresaElegida) {
...
// cambio los elementos en pantalla 
	...
	var _auxInterno = _valorIndice + 1;

	_logHeineken[_valorIndice+1] = _valorHeineken;
	_logGatorade[_valorIndice+1] = _valorGatorade;
	_logNike[_valorIndice+1] = _valorNike;
	_logMcDonalds[_valorIndice+1] = _valorMcDonalds;
	...
	if (_jugadores[0][0] != "Sin Asignar") {
		...
		_logJugador_1[_valorIndice+1]=0;
	...
	if (_jugadores[1][0] != "Sin Asignar") {
		...
		_logJugador_2[_valorIndice+1]=0;
	...
	if (_jugadores[2][0] != "Sin Asignar") {
		...
		_logJugador_3[_valorIndice+1]=0;
	...
	if (_jugadores[3][0] != "Sin Asignar") {
		...
		_logJugador_4[_valorIndice+1]=0;
...
//	_logJugador_4[_valorIndice+1]=Number(format2Num(document.getElementById("Jugador4_Total").innerHTML));
	...
	_logLabels[_valorIndice+1]=_auxInterno.toString();
...
// vacio el maso de cartas 
	...
	document.getElementById("Jugador"+String(_turnoJugador+1)+"_Linea").style= "border-style: solid; border-color: black; border-width: 0.5px;" ;
	document.getElementById("Jugador"+String(_turnoJugador+1)+"_V_Linea").style= "border-style: solid; border-color: black; border-width: 0.5px;" ;
...
//		<div id="barras" style="margin-top: 10px;">
//			<img src="_imagenes/barras75.png" > 
//		</div>
...
function cambiargraficaLinea() {
	if (_queGraficaVa == "A") {
		_queGraficaVa = "B";
		document.getElementById("TituloGraficas").innerHTML = "ESTADISTICAS DE JUGADORES";
		grafcaLineal();
	}else{

		_queGraficaVa = "A";
		document.getElementById("TituloGraficas").innerHTML = "ESTADISTICAS DE EMPRESAS";
		grafcaLineal();
